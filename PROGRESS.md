...
- [ ] MT0-01 SSOT v3 패치(CHANGES_V3) + 모델 ID 적용·스모크 검증(D-20)
  - 2026-08-02: §0~§5+§3.5 적용분 2단 판정 PASS(qa-verifier→aaa-critic, docs/reviews/REVIEW_M0.md). 커밋 348f1b9·5e190a9. 잔여: 모델 ID 스모크 검증 — ANTHROPIC_API_KEY 부재로 차단(사용자 상신 중). 참고: registry_version 0.1.0 vs 문서 "0.2.0" 불일치는 MT0-05 착수 전 해소(O-3)
